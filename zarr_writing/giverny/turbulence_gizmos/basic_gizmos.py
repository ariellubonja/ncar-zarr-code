...
def check_dataset_title(dataset_title):
    ...
    valid_dataset_titles = ['isotropic4096', 'isotropic8192', 'sabl2048b']
...
def check_variable(variable, dataset_title):
    ...
    valid_variables = {'isotropic4096':['pressure', 'velocity'], 'isotropic8192':['pressure', 'velocity'],
                       'sabl2048b':['pressure', 'velocity', 'temperature', 'energy']}
    
    if variable not in valid_variables[dataset_title]:
        raise Exception(f"'{variable}' (case-sensitive) is not a valid variable: {valid_variables[dataset_title]}")
...
def get_timepoint_digits(dataset_title):
    # get the number of digits in the timepoint in order to add leading zeros.
    return {
        'isotropic4096':1,
        'isotropic8192':1,
        'sabl2048b':3
