...
def prepare_data(xr_path, desired_cube_side=512, chunk_size=64, dask_local_dir='/home/idies/workspace/turb/data02_02', n_dask_workers=4): # use_dask=True
    ...
    client = Client(n_workers=n_dask_workers, local_directory=dask_local_dir, memory_limit='500GB', processes=False)
    ...
    for var in ['p', 't', 'e']:
        client = Client(n_workers=2, local_directory=dask_local_dir, processes=False, memory_limit='500GB')
